...
const ChartPage = () => {
  ...
  const getDataTransaction = async () => {
    ...
    const res = await fetch(
      // `https://api-m.sandbox.paypal.com/v1/reporting/transactions?start_date=2024-05-08T23:59:59-0700&end_date=2024-06-07T23:59:59-0700&fields=all`,
    ...
    const result = await data?.transaction_details?.map((invoice: any) => ({
      label: formatDateDDMM(invoice?.transaction_info?.transaction_initiation_date),
            ...
            <Col span={12}>
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                  ...
                  >
                    <DatePicker minDate={dayjs(startDate)} maxDate={dayjs(endDate)} />
                  </Form.Item>
                </div>
